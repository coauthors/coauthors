...
<div class="py-4 pt-8 text-xl">
  "We leave tons of commits every day. among these commits,{' '}
  <b>there are many commits that were created based on ideas given to me by colleagues.</b> In fact, good ideas are not
...
The Coauthors GitHub App automatically provides a string that matches the co-authoring syntax so that contributors can easily add them as co-authors on their own commits, even if they only left comments. This works in GitHub Issues and Pull Requests. [GitHub App Marketplace →](https://github.com/apps/coauthors)

![Example](/img/github-app-example.png)

### Coauthors Generator 🌐

We provide a simple web page that allows you to enter a GitHub username and create a commit message. Our tool automatically searches all information required for co-authoring through the entered GitHub username and creates a commit message. [Go to use →](/generator)
