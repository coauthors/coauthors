...
const config: DocsThemeConfig = {
  logo: function Logo() {
    return (
      <div className="flex items-center gap-1">
        <Image src="/img/logo_dark.png" width={34} height={34} alt="coauthors logo" />
  ...
  head: function Head() {
    ...
    const url = `https://coauthors.vercel.app${defaultLocale === locale ? asPath : `/${locale}${asPath}`}`
  ...
  docsRepositoryBase: 'https://github.com/coauthors/coauthors/tree/main/docs/coauthors.io',
  useNextSeoProps() {
